# v3 — batch_size 64 → 128 (v2 대비 변경)
# Submission: submission_v3_batch128.csv
...
if __name__ == "__main__":
    ...
    best_acc  = 0; _exp_name = "fruit_classification_v3"
    print(f"v3 | batch_size={batch_size} | Device={device}")
    ...
    plt.suptitle("v3 — batch_size=128", fontsize=13); plt.tight_layout()
    plt.savefig("v3_training_curve.png", dpi=150); plt.close()
    ...
    df.to_csv(submission_dir / "submission_v3_batch128.csv", index=False)
    print(f"Saved: {submission_dir / 'submission_v3_batch128.csv'}")
    ctypes.windll.user32.MessageBoxW(0, "v3 Done! batch_size=128", "Done", 1)
