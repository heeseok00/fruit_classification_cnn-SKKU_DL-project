...
#
# 근거:
#   - v5(AdamW, 0.95541)와 v8(160×160, 0.95358) 각각 단독으로 효과 확인
#   - 두 변경사항을 동시에 적용하면 시너지 가능성
#   - 160×160은 단독으론 v5보다 낮았지만, AdamW와 결합 시 달라질 수 있음
#
# Submission: Data/submissions/submission_v10_adamw_160.csv
# ============================================================
...
if __name__ == "__main__":
    ...
    best_acc  = 0
    _exp_name = "fruit_classification_v10"
    print(f"v10 | AdamW + label_smoothing + 160x160 | Device={device}")
    ...
    plt.suptitle("v10 — AdamW + label_smoothing + 160x160", fontsize=13)
    plt.tight_layout()
    plt.savefig("v10_training_curve.png", dpi=150); plt.close()
    ...
    df.to_csv(submission_dir / "submission_v10_adamw_160.csv", index=False)
    print(f"Saved: {submission_dir / 'submission_v10_adamw_160.csv'}")
    print("Done!")
